          ...
          >
            ...
            >
              ...
              >
                ...
                <span v-else-if="dialogType === 'info'" class="d-flex align-items-center text-white"><InfoIcon class="mr-1" style="height: 22px; width: 22px"/>{{ dialogTitle }}</span>
              ...
              <div class="mt-4 flex justify-content-end">
                <button
                  v-if="dialogType === 'success' || dialogType === 'info'"
                  type="button"
                  class="inline-flex justify-center rounded-md border-transparent btn-custom btn-main px-4 py-2 text-sm font-medium text-white hover:bg-success-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
