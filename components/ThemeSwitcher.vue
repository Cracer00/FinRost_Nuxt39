  ...
  <div class="flex items-center">
    ...
    >
      ...
      <ListboxButton
        type="button"
        title="Изменить тему"
        class="transition-colors duration-300 dark:text-white"
      >
        <span class="flex justify-center items-center dark:hidden">
          <el-button circle><IconUil:sun /></el-button>
        </span>
        <span class="justify-center items-center hidden dark:flex">
           <el-button circle><IconUil:moon /></el-button>
        </span>
      </ListboxButton>
      <ListboxOptions
      ...
      >
        <ListboxOption
          ...
          :class="{
            ...
            'text-gray-700 bg-gray-100 dark:bg-gray-300':
              themeSetting === theme.key,
            'text-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30':
              themeSetting !== theme.key,
          }"
        >
